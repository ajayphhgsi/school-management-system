...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Create a new exam and schedule subjects</p>
    </div>
    <div>
    ...
    <div class="card-body">
        <style>
            ...
            .date-input { width: 140px; }
                        ...
                        <form id="examForm" action="/admin/exams/store" method="POST">
                                    ...
                                    <div id="classSelection">
                                        <?php foreach ($classes as $class): ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input class-checkbox" type="checkbox" id="class_<?php echo $class['id']; ?>" name="class_ids[]" value="<?php echo $class['id']; ?>">
                    ...
                    ${classData.subjects.map((subject, index) => `
                        <div class="row mb-3 align-items-end">
                            <div class="col-md-3">
                                ...
                                <input type="hidden" name="subjects[${index}][class_id]" value="${subject.class_id}">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Date</label>
                                <input type="date" class="form-control date-input subject-date" name="subjects[${index}][exam_date]">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Start Time</label>
                                <input type="time" class="form-control time-input subject-start-time" name="subjects[${index}][start_time]">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">End Time</label>
                                <input type="time" class="form-control time-input subject-end-time" name="subjects[${index}][end_time]">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Max Marks</label>
                                <input type="number" class="form-control subject-max-marks" name="subjects[${index}][max_marks]" value="100" min="1">
                            </div>
                            <div class="col-md-1">
