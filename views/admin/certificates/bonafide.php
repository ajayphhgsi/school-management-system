...
$page_title = 'Bonafide Certificates';
ob_start();
?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1"><i class="fas fa-stamp text-warning me-2"></i>Bonafide Certificates</h4>
        <p class="text-muted mb-0">Manage issued bonafide certificates</p>
    </div>
...
<?php else: ?>
    <div class="text-center py-5">
        <i class="fas fa-stamp fa-4x text-muted mb-3"></i>
        <h4 class="text-muted">No Bonafide Certificates Found</h4>
        <p class="text-muted">Bonafide certificates will appear here once issued.</p>
