...
<div class="card">
    <div class="card-body">
        <form method="POST" action="/admin/subjects/update/<?php echo $subject['id']; ?>">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="subject_name" name="subject_name"
                           value="<?php echo $_SESSION['flash']['old']['subject_name'] ?? $subject['subject_name']; ?>" required>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="subject_code" class="form-label">Subject Code *</label>
                    <input type="text" class="form-control" id="subject_code" name="subject_code"
                           value="<?php echo $_SESSION['flash']['old']['subject_code'] ?? $subject['subject_code']; ?>" required>
                </div>
            </div>

            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea class="form-control" id="description" name="description" rows="3"><?php echo $_SESSION['flash']['old']['description'] ?? $subject['description']; ?></textarea>
            </div>

            <div class="mb-3">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo ($_SESSION['flash']['old']['is_active'] ?? $subject['is_active']) ? 'checked' : ''; ?>>
